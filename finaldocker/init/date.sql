...
insert into person(login, password, last_name, first_name, middle_name, birth_date, phone, email, snils, created_by,
                   created_when, modified_by, modified_when)
values ('User2003', 'Delay2003*', 'Иванов', 'Петр', 'Перович', '05.12.1965', '+7-911-513-11-22',
        'delay2003@mail.ru', '213-222-111 22',
        'Admin', now(), 'Admin', now()),
       ('User2004', 'Delay2003*', 'Свиридова', 'Антонина', 'Леопольдовна', '05.03.1955', '+7-911-777-22-33',
        'delay2004@mail.ru', '123-123-123 22',
        'Admin', now(), 'Admin', now()),
       ('User2005', 'Delay2003*', 'Загинайло', 'Марина', 'Львовна', '06.12.1970', '+7-911-135-12-11',
        'delay2005@mail.ru', '123-123-215 77',
        'Admin', now(), 'Admin', now()),
       ('User2006', 'Delay2003*', 'Петров', 'Степан', 'Иванович', '05.03.1955', '+7-911-777-22-33',
        'delay2006@mail.ru', '123-182-777 65',
        'Admin', now(), 'Admin', now()),
       ('User2007', 'Delay2003*', 'Милорадов', 'Илларион', 'Анатольевич', '12.10.1990', '+7-911-784-11-22',
        'delay2007@mail.ru', '122-175-112 50',
        'Admin', now(), 'Admin', now()),
       ('User2008', 'Delay2003*', 'Миронов', 'Иван', 'Петрович', '06.04.1975', '+7-911-682-12-55',
        'delay2008@mail.ru', '131-123-155 22',
        'Admin', now(), 'Admin', now()),
       ('User2009', 'Delay2003*', 'Кудрешова', 'Марина', 'Ивановна', '12.10.1970', '+7-911-311-11-33',
        'delay2009@mail.ru', '178-112-111 22',
        'Admin', now(), 'Admin', now()),
       ('User2010', 'Delay2003*', 'Аппалонова', 'Светлана', 'Николаевна', '05.05.1970', '+7-911-124-22-33',
        'delay2010@mail.ru', '256-213-123 22',
        'Admin', now(), 'Admin', now()),
       ('User2011', 'Delay2003*', 'Попова', 'Светлана', 'Рудольфовна', '12.05.1980', '+7-911-231-23-33',
        'delay2011@mail.ru', '321-555-756 22',
        'Admin', now(), 'Admin', now()),
       ('User2004', 'Delay2003*', 'Кислицкая', 'Венера', 'Степановна', '05.12.1981', '+7-911-777-22-33',
        'delay2012@mail.ru', '123-123-759 22',
        'Admin', now(), 'Admin', now());
insert into person(login, password, last_name, first_name, middle_name, birth_date, phone, email, snils, created_by,
                   created_when, modified_by, modified_when)
values ('Laborant2003', 'Delay2003*', 'Потапова', 'Светлана', 'Ивановна', '06.10.1978', '+7-911-231-13-12',
        'laborant2003@mail.ru', '124-135-223 11',
        'Admin', now(), 'Admin', now()),
       ('Laborant2004', 'Delay2003*', 'Самсонова', 'Ирина', 'Васильевна', '07.11.1955', '+7-911-750-22-78',
        'laborant2004@mail.ru', '123-175-131 22',
        'Admin', now(), 'Admin', now()),
       ('Laborant2005', 'Delay2003*', 'Петрова', 'Мария', 'Ивановна', '08.12.1978', '+7-911-751-33-44',
        'laborant2005@mail.ru', '123-175-131 22',
        'Admin', now(), 'Admin', now()),
       ('Laborant2006', 'Delay2003*', 'Пунцева', 'Валерия', 'Витальевна', '09.01.1990', '+7-911-005-11-22',
        'laborant2006@mail.ru', '124-222-059 12',
        'Admin', now(), 'Admin', now()),
       ('Laborant2007', 'Delay2003*', 'Румянцев', 'Петр', 'Мелентьевич', '09.02.1995', '+7-911-015-22-08',
